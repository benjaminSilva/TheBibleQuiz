package com.example.novagincanabiblica.ui.theme
...
val darkYellow = Color(0xFFC59B1B)
val closeToBlack = Color(0xFF424242)
val darkGray = Color(0xFF6B6B6B)
val wrongAnswerSelected = Color(0xffef9a9a)
val wrongAnswer = Color(0xffffcdd2)
val wrongAnswerDark = Color(0xffc62828)
val correctAnswer = Color(0xffc5e1a5)
