...
sealed class FeedbackMessage(val messageId: Int, val extraData: Array<out Any> = arrayOf()) {
    //Error
    ...
    class WordNotLongEnough(length: Int): FeedbackMessage(R.string.error_word_not_long_enough, extraData = arrayOf(length))
